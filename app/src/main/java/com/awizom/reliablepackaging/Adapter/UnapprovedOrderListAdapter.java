...
public class UnapprovedOrderListAdapter extends RecyclerView.Adapter<UnapprovedOrderListAdapter.MyViewHolder> {

    private List<Order> orderList;
    private Context mCtx;
    private AlertDialog progressDialog;

    public UnapprovedOrderListAdapter(Context baseContext, List<Order> orderList) {
    ...
    /*    holder.categoryImage.setOnClickListener(new View.OnClickListener() {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog.show();
                Intent intent = new Intent(mCtx, UnapprovedOrderDetails.class);
                intent.putExtra("OrderId", holder.orderid.getText().toString());
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapater_unapprovedorderlistadp, parent, false);
